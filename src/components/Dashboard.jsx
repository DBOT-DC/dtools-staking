  ...
  return (
    <section className="mb-8">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        <StatsCard
          label="Your Balance"
          value={account ? formatSym(tokenBalance) : '—'}
          icon={<WalletIcon />}
          accent="amber"
          tooltip="DTOOLS tokens in your wallet"
        />
        <StatsCard
          label="Your Staked"
          value={account ? formatSym(stakedAmount) : '—'}
          icon={<StakeIcon />}
          accent="blue"
          tooltip="DTOOLS tokens you have staked"
        />
        <StatsCard
          label="Pending Rewards"
          value={account ? formatSym(pendingReward) : '—'}
          icon={<RewardIcon />}
          accent="emerald"
          tooltip="Earned rewards available to claim"
        />
        <StatsCard
          label="Total Staked (TVL)"
          value={formatSym(totalStaked)}
          icon={<TVLIcon />}
          accent="purple"
          tooltip="Total DTOOLS staked in the contract"
        />
        <StatsCard
          label="APY"
          value={apy !== null && apy !== undefined ? `${Number(apy)}%` : '—'}
          icon={<APYIcon />}
          accent="amber"
        ...
        <StatsCard
          ...
          value={formatSym(rewardsRemaining)}
        ...
        <StatsCard
          ...
          accent="slate"
          tooltip="Connected to Dogechain mainnet"
        />
      </div>
    </section>
  );
